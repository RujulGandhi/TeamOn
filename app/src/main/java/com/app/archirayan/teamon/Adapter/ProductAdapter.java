...
public class ProductAdapter extends BaseAdapter {
    ...
    public ProductAdapter(Context context, ArrayList<ProductDetail> arrayListCommentds, FragmentManager supportFragmentManager) {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (object.getString("status").equalsIgnoreCase("true")) {
                    ...
                    Gson gson = new Gson();
                    WriteSharePrefrence(context, ALLPRODUCT, gson.toJson(arrayList));
//                    if (task.equalsIgnoreCase("add")) {
