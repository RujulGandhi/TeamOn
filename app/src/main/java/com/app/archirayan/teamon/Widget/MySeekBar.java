...
/**
 * Created by archirayan on 16-Dec-16.
 */
...
public class MySeekBar extends SeekBar {
    ...
    public MySeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mThumbSize = getResources().getDimensionPixelSize(R.dimen._20sdp);

        mTextPaint = new TextPaint();
        mTextPaint.setColor(Color.WHITE);
        mTextPaint.setTextSize(getResources().getDimensionPixelSize(R.dimen._10sdp));
