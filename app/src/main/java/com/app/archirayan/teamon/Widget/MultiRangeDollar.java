 ...
 */
public class MultiRangeDollar<T extends Number> extends ImageView {
    /**
     * Default color of a {@link RangeSeekBar}, #FF33B5E5. This is also known as "Ice Cream Sandwich" blue.
     */
    public static final int ACTIVE_COLOR = Color.parseColor("#7e3d97");
    /**
    ...
    public static final Integer DEFAULT_MAXIMUM = 500;
    public static final int HEIGHT_IN_DP = 30;
    //    public static final int TEXT_LATERAL_PADDING_IN_DP = 3;
    public static final int TEXT_LATERAL_PADDING_IN_DP_MIN = 3;
    public static final int TEXT_LATERAL_PADDING_IN_DP_MAX = 30;
    ...
    public MultiRangeDollar(Context context) {
        super(context);
        init(context, null);
    }

    public MultiRangeDollar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MultiRangeDollar(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs == null) {
            setRangeToDefaultValues(0d, 100d);
    ...
    public void setRangeToDefaultValues(Double min, Double max) {
//        this.absoluteMinValue = (T) DEFAULT_MINIMUM;
//        this.absoluteMaxValue = (T) DEFAULT_MAXIMUM;
        this.absoluteMinValue = (T) min;
        this.absoluteMaxValue = (T) max;
        setValuePrimAndNumberType();
    }
...
//            String maxLabel = getContext().getString(R.string.demo_max_label);
            minMaxLabelSize = Math.max(paint.measureText(""), paint.measureText(""));
        ...
        boolean selectedValuesAreDefault = false;/*(getSelectedMinValue().equals(getAbsoluteMinValue()) &&
        ...
        if (mShowTextAboveThumbs && (mActivateOnDefaultValues || !selectedValuesAreDefault)) {
            ...
            int offset = PixelUtil.dpToPx(getContext(), TEXT_LATERAL_PADDING_IN_DP_MAX);
            int offsetMin = PixelUtil.dpToPx(getContext(), TEXT_LATERAL_PADDING_IN_DP_MIN);

            String minText = "$" + String.valueOf(getSelectedMinValue());
            String maxText = "$" + String.valueOf(getSelectedMaxValue());
            float minTextWidth = paint.measureText(minText) + offsetMin;
    ...
    public interface OnRangeSeekBarChangeListener<T extends Number> {
        ...
        void onRangeSeekBarValuesChanged(MultiRangeDollar<T> bar, T minValue, T maxValue);
    }
