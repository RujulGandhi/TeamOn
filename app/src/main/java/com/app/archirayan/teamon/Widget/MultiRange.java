 ...
 */
public class MultiRange<T extends Number> extends ImageView {
    /**
    ...
    public MultiRange(Context context) {
        super(context);
        init(context, null);
    }

    public MultiRange(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MultiRange(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setRangeToDefaultValues(Integer min, Integer max) {
...
//            String maxLabel = getContext().getString(R.string.demo_max_label);
    ...
    public interface OnRangeSeekBarChangeListener<T extends Number> {
        ...
        void onRangeSeekBarValuesChanged(MultiRange<T> bar, T minValue, T maxValue);
    }
