...
public class RegisterActivity extends AppCompatActivity {
    ...
    public TextView txtSignUp, txtagreetrems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtname = (EditText) findViewById(R.id.activity_register_username);
        txtemail = (EditText) findViewById(R.id.activity_register_email);
        txtpwd = (EditText) findViewById(R.id.activity_register_password);
        txtrepwd = (EditText) findViewById(R.id.activity_register_repassword);
        ivTerm = (ImageView) findViewById(R.id.activity_register_iv_term_conition);
        txtSignUp = (TextView) findViewById(R.id.activity_sign_in_txtSignUp);
        ivTermCorrect = (ImageView) findViewById(R.id.activity_register_term_condition_correct);
        ivNameCorrect = (ImageView) findViewById(R.id.activity_register_true_user_name);
        ivNameCross = (ImageView) findViewById(R.id.activity_register_cross_user_name);
        ivEmailCorrect = (ImageView) findViewById(R.id.activity_register_true_email);
        ivEmailCross = (ImageView) findViewById(R.id.activity_register_cross_email);
        ivPassworsCorrect = (ImageView) findViewById(R.id.activity_register_true_pasword);
        ivPasswordCross = (ImageView) findViewById(R.id.activity_register_cross_password);
        ivRePasswordCross = (ImageView) findViewById(R.id.activity_register_cross_repassword);
        ivRePasswordCorrect = (ImageView) findViewById(R.id.activity_register_true_repasword);


        txtpwd.setTransformationMethod(new AsteriskPasswordTransformationMethod());
        txtrepwd.setTransformationMethod(new AsteriskPasswordTransformationMethod());
                        ...
                        if (strPwd.length() > 3) {
                            ...
                            if (strRepsw.length() > 3) {
                                ...
                                if (strPwd.equals(strRepsw)) {
                                    ...
                                    ivRePasswordCorrect.setVisibility(View.VISIBLE);
                                    if (IsTermSelected) {
                                        new SignUp(strName, strEmail, strPwd).execute();
                                    } else {
                                        Toast.makeText(RegisterActivity.this, "please select the terms", Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                                    ivRePasswordCross.setVisibility(View.VISIBLE);
                                    ivRePasswordCorrect.setVisibility(View.INVISIBLE);
    ...
    private class SignUp extends AsyncTask<String, String, String> {
        ...
        public SignUp(String strName, String strEmail, String strPwd) {
            this.name = strName;
            this.email = strEmail;
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("true")) {
                    ...
                    Intent i = new Intent(RegisterActivity.this, LetsGoActivity.class);
